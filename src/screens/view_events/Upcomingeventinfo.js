...
class Upcomingeventinfo extends React.Component {
        ...
        <View style={styles.bottomItem}>
          <TouchableOpacity>
            ...
            <View style={styles.rectangle}>
              ...
              <Text style={styles.textdesign}>{item.venue}</Text>
              <Text
                style={{
                  fontSize: 22,
                  fontFamily: 'Roboto',
              ...
              <Text style={styles.textdesign}>{item.capacity}</Text>
            </View>
          </TouchableOpacity>
        </View>
      </ScrollView>
  ...
  handle_join() {
    data = {
      endpoint: '/eventParticipant/joinEvent',
      method: 'POST',
      data: {eventId: this.state.data._id},
      token: count.token,
    };
...
export default connect(mapStateToProps, mapDispatchToProps)(Upcomingeventinfo);
